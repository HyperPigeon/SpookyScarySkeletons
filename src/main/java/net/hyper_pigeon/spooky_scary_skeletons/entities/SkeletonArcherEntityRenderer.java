...
public class SkeletonArcherEntityRenderer extends BipedEntityRenderer<SkeletonArcherEntity, SkeletonEntityModel<SkeletonArcherEntity>> {

    private static final Identifier TEXTURE = new Identifier("textures/entity/skeleton/skeleton.png");

    public SkeletonArcherEntityRenderer(EntityRenderDispatcher dispatcher) {
    ...
    public Identifier getTexture(SkeletonArcherEntity skeletonArcherEntity) {
        return TEXTURE;
    }
